...
export default async function Home({
  ...
  <div className="max-w-7xl mx-auto px-6 py-10 md:py-12 text-center">
    ...
    <p className="text-base md:text-lg text-blue-100 max-w-2xl mx-auto leading-relaxed">
      Discover the best Amazon & Flipkart deals, trending products,
      honest recommendations, and budget-friendly shopping —
      all in one place.
    </p>
      ...
      >
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">
            Handpicked products, trending offers, and smart shopping picks
            updated regularly.
          </p>
        </div>
