          ...
          <section className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white">
            <div className="max-w-7xl mx-auto px-6 py-10 md:py-12 text-center">
              ...
              <h1 className="text-3xl md:text-5xl font-extrabold mb-3">
                Welcome to <span className="text-yellow-300">AnantaGo</span>
              </h1>
              ...
              <div className="mt-6 flex flex-wrap justify-center gap-3">
                <a
                  href="#featured-deals"
                  className="bg-white text-blue-700 font-semibold px-5 py-2.5 rounded-full hover:bg-gray-100 transition"
                >
                  🔥 Explore Deals
                </a>
                ...
                <a
                  href="/blog"
                  className="border border-white px-5 py-2.5 rounded-full hover:bg-white hover:text-blue-700 transition"
                >
                  📖 Read Blogs
                </a>
              </div>
